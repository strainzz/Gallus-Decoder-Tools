...
- `{"tool":"span","start":"01/01/2020","end":"09/22/2026"}` accepts `MM/DD/YYYY`, `YYYY-MM-DD`, or `Month D, YYYY`. Add `"include_end":true` to count the end date. `numerology.start` and `numerology.end` hold DN1, DN2, DN3, and DN4. Use `steps` for the addition. Do not estimate those numbers.
